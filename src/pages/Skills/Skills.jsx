  ...
  const skillCategories = [
    {
      ...
      color: "text-blue-400",
   skills: [
        { name: "React.js", icon: <BsFileEarmarkCode className="w-4 h-4 text-[#61DAFB]" /> },
        { name: "Angular", icon: <BsFileEarmarkCode className="w-4 h-4 text-[#DD0031]" /> },
        ...
        { name: "Bootstrap", icon: <BsFileEarmarkCode className="w-4 h-4 text-[#563D7C]" /> },
    ...
    },
    {
     ...
     skills: [
        ...
        { name: "Express.js", icon: <BsGrid1X2 className="w-4 h-4 text-[#000000]" /> },
        { name: "PHP", icon: <BsFileEarmarkCode className="w-4 h-4 text-[#777BB4]" /> },
    ...
    {
      icon: Layout,
      title: "UI/UX Design & Programming Languages",
